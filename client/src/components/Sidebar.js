...
import "/home/sufi/Documents/WT project/client/src/features/Sidebar.css";
...
function Sidebar() {
    ...
    return (
        <>
            <h2 style={{"margin-top":"50px", "margin-bottom": "30px", "font-weight":"Bold", "color":"#161748"}}>Available rooms</h2>
            <ListGroup>
                {rooms.map((room, idx) => (
            ...
            <h2 style={{"margin-top":"50px", "margin-bottom": "30px", "font-weight":"Bold", "color":"#161748"}}>Members</h2>
            {members.map((member) => (
